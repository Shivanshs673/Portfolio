        ...
        <div className="mt-8 grid grid-cols-1 gap-5 lg:grid-cols-[0.9fr_1.1fr] sm:mt-12 sm:gap-6">
          ...
          <ScrollReveal direction="left">
            <Card className="glass relative flex h-full flex-col overflow-hidden p-5 sm:p-6 md:p-8">
              <GlassShimmer />
              <h3 className="text-base font-semibold text-white sm:text-lg">Problem Difficulty Breakdown</h3>
              <p className="mt-1 text-xs text-slate-400">Total solved questions vs global question pool</p>
              ...
              <div className="mt-8 flex flex-col items-center gap-6 sm:flex-row sm:justify-around">
                ...
                <div className="relative flex h-36 w-36 shrink-0 items-center justify-center">
                  ...
                  <div className="absolute flex flex-col items-center justify-center text-center">
                    <span className="text-2xl font-extrabold text-white sm:text-3xl">{stats.totalSolved}</span>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:gap-6">
            <ScrollReveal direction="up" delay={0.05}>
              <Card className="glass relative overflow-hidden p-5 sm:p-6">
                ...
                <div className="flex items-start gap-4">
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl border border-amber-400/20 bg-amber-500/10 text-amber-400 sm:h-12 sm:w-12">
                    <Award className="h-5 w-5" />
                  </div>
                  <div>
                    <p className="text-xs uppercase tracking-wider text-slate-400">Contest Rating</p>
                    <h4 className="mt-1 text-2xl font-bold text-white sm:text-3xl">
            ...
            <ScrollReveal direction="up" delay={0.1}>
              <Card className="glass relative overflow-hidden p-5 sm:p-6">
                <GlassShimmer />
                <div className="flex items-start gap-4">
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl border border-cyan-400/20 bg-cyan-500/10 text-cyan-400 sm:h-12 sm:w-12">
                    <TrendingUp className="h-5 w-5" />
                  </div>
                  <div>
                    <p className="text-xs uppercase tracking-wider text-slate-400">Global Ranking</p>
                    <h4 className="mt-1 text-2xl font-bold text-white sm:text-3xl">
            ...
            <ScrollReveal direction="up" delay={0.15} className="sm:col-span-2">
              <Card className="glass relative overflow-hidden p-5 sm:p-6">
                <GlassShimmer />
                <div className="flex items-start gap-4">
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl border border-purple-400/20 bg-purple-500/10 text-purple-400 sm:h-12 sm:w-12">
                    <Code2 className="h-5 w-5" />
                  </div>
                  <div>
                    <p className="text-xs uppercase tracking-wider text-slate-400">Consistency Focus</p>
